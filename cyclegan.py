...
train_horses = tf.data.Dataset.list_files(PATH+'sample_1200/trainA/*.jpg')
...
train_zebras = tf.data.Dataset.list_files(PATH+'sample_1200/trainB/*.jpg')
...
test_horses = tf.data.Dataset.list_files(PATH+'sample_1200/testA/*.jpg')
...
test_zebras = tf.data.Dataset.list_files(PATH+'sample_1200/testB/*.jpg')
